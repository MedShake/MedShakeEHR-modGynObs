...
(30, 'typecs', 'csObs', 'Consultations obstétricales', 'consultations pendant grossesse', 'user', 1, '2017-06-15 11:02:18'),
...
(485, 'medical', 'terme9mois', '', 'Terme (9 mois)', 'terme', '', '', 'text', '', 'user', 32, 1, '2017-06-13 10:16:56', 3600, 1),
...
--
ALTER TABLE `data_cat`
  MODIFY `id` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
